...
spruce.
  controller('NewEntryCtrl', ['$scope', '_Parse', '$routeParams', '$location', 'sharedState', '$timeout', function($scope, _parse, $routeParams, $location, sharedState, $timeout) {
    ...
    ,{'name': "Assuming the Worst Case Scenario", 'fullDescription': "Sometimes we automatically go to an extremely negative end of the spectrum. If you think about the range of possibilities, is it really as bad as you imagine? What are some other possible ways in which you could state this that are more moderate?", 'shortDescription': "Does this statement seem at all extreme?"}
    ...
    ,{'name': "All-Or-Nothing Thinking", 'fullDescription': "Are you seeing things in black and white? Are convinced one particular thing is going to happen, when actually there a number of different things that could happen?", 'shortDescription': "Does this statement assume that a single outcome is inevitable?"}
    ];
